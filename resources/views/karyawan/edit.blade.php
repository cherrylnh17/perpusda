                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <select name="id_pendidikan"
                                        ...
                                        @foreach($pendidikans as $p)
                                            <option value="{{ $p->id_pendidikan }}" {{ old('id_pendidikan', $karyawan->id_pendidikan) == $p->id_pendidikan ? 'selected' : '' }}>{{ $p->jenjang }}</option>
                                        @endforeach
                                    </select>
                                    @error('id_pendidikan')
                                        <p class="text-xs text-red-500 mt-1">{{ $message }}</p>
                                ...
                                <div>
                                    ...
                                    <input type="text" name="nama_pendidikan"
                                           value="{{ old('nama_pendidikan', $karyawan->nama_pendidikan) }}" maxlength="100"
